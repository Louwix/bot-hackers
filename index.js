...
var volume = 0.5;
var channel = '';
let messageId = '';var deleteChannel = ['coin-admin','commande-bot','suggestion-serveur-discord']
    ...
    function start (url){
      ...
      case 'help':
        ...
        message.channel.sendEmbed(new Discord.RichEmbed()
          ...
          .addField(">Emojie","Le bot vous affichera tous les emojies realiser pour le serveur Discord")
          .setColor('GREEN')
        );
