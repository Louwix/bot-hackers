...
bot.on('guildMemberAdd', function(guildMember) {
	...
	var textChannelRegles = guild.channels
		...
		.first();
	textChannelNouveaux.send("Bienvenue à " + guildMember + " sur le serveur Discord Hackers. Je t'invite à lire dès maintenant le salon "+ textChannelRegles +". ("+ guild.memberCount +" membres)")
})
